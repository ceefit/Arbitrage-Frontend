...
class RealTime extends React.Component {
  ...
  render() {
    ...
    const fiveMinuteStyle = {
      value: {
        normal: { fille: 'none', stroke: '#619F3A', strokeWidth: 3, opacity: 0.7 },
        highlight: { fille: 'none', stroke: '619F3A', strokeWidth: 3, opacity: 0.8 },
        selected: { fille: 'none', stroke: '619F3A', strokeWidth: 3, opacity: 0.8 }
      }
    };
